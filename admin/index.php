...
if(@$_POST["login"]){ //jika tombol Login diklik
	...
	if($user!="" && $pass!=""){
		...
		if($data["username"] == $user && $data["password"] == $pass){
			...
			$_SESSION["usernameku"]=$data["username"];
			$_SESSION["passwordku"]=$data["password"];
...
?>
   <!-- PAGE CONTENT --> 
    ...
    <div class="tab-content">
		...
		<center><img src="../images/logo-1.png" height="100"/><br><font color="blue"><br><b>Selamat Datang Di Halaman Login Admin</b></font></center> <br>
