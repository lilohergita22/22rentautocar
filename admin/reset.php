...
$username=@$_POST['username'];
 $checkMIEZdataThisismytechnique="select username from tbl_admin where username='$username'";
$cekdataapakahadaatautidakditakengonscript=mysql_query($checkMIEZdataThisismytechnique) or die(mysql_error());
  ...
  { 
$result=mysql_query("select * from tbl_admin where username='$_POST[username]'");
